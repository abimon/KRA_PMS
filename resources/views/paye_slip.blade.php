...
<div style="min-height:75%;">
    ...
    <p style="font-weight:bold;text-align:center;">PAYE: <span
            style="text-decoration:underline;font-weight:bolder; color:red;">{{$paye}}</span></p>
</div>
<p style="text-align:center;margin-top:10px;">*This receipt is system generated by Group 1</p>
<p style="text-align:center;margin-top:10px;">&copy;{{date('Y')}} All rights reserved. KRA Paye Mangement System Group 1.</p>