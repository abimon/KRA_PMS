...
<form method="POST" action="{{ route('register') }}">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="row mb-3">
                <label for="lname" class="col-md-4 col-form-label text-md-end">{{ __('Surname') }}</label>
        ...
        <div class="col-md-6">
            <div class="row mb-3">
                <label for="nid" class="col-md-4 col-form-label text-md-end">{{ __('ID number') }}</label>

                <div class="col-md-8">
                    <input id="nid" type="text" class="form-control @error('nid') is-invalid @enderror" name="nid"
                        value="{{ old('nid') }}" required autocomplete="nid" maxlength="8" minlength="7">
        ...
        <div class="col-md-6">
            <div class="row mb-3">
                <label for="email" class="col-md-4 col-form-label text-md-end">{{ __('KRA PIN') }}</label>
                <div class="col-md-8">
                    <input id="kpin" type="text" class="form-control @error('kpin') is-invalid @enderror" name="kpin"
        ...
        <div class="col-md-6">
            <div class="row mb-3">
                <label for="email" class="col-md-4 col-form-label text-md-end">{{ __("Employer's Name") }}</label>
                <div class="col-md-8">
                    <input id="employer" type="text" class="form-control @error('employer') is-invalid @enderror"
                        name="employer" value="{{ old('employer') }}" required autocomplete="employer">
        ...
        <div class="col-md-6">
            <div class="row mb-3">
                <label for="email" class="col-md-4 col-form-label text-md-end">{{ __("Employer's KRA") }}</label>
                <div class="col-md-8">
