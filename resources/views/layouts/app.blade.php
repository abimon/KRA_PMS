...
<body>
    ...
    <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50" style="max-height:100vh;">

        <!-- https://laravel.com/assets/img/welcome/background.svg -->
        <div class="relative flex flex-col items-center justify-center text-white" style="height:100vh;">
